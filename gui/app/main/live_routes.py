...
def live_multiple_answers():
    ...
    if form.submit.data:
        ...
        if sorted(answers) == sorted(live_ans_list) :
            # Correct answer 
            answer_choices = []
            ...
            live_ans_list = [img1_chosen[0][1].title(),img2_chosen[0][1].title()]
            ...
            to_be_removed = ["","His ","Her ","Hers ","Her's ","Its ","It's ","Other ","Another ","Their ","Or ","Your ","Yours ","These "]
            new_choices = []
            for ch in live_ans_list:
                for word in to_be_removed:
                    if word in ch:
                        ch = ch.replace(word,"")
                new_choices.append(ch)
            live_ans_list = new_choices
            print "Correct Answers:",live_ans_list
